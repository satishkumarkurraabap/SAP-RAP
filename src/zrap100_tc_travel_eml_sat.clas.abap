"! @testing BDEF:ZR_RAP_ATRAV_SAT000
CLASS zrap100_tc_travel_eml_sat DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
  FOR TESTING
...
CLASS zrap100_tc_travel_eml_sat IMPLEMENTATION.
...
*            FROM VALUE #( ( %cid_ref = 'ROOT1' ) )
     ...
     cl_abap_unit_assert=>assert_not_initial( msg = 'mapped-travel'  act = mapped-ZrRapAtravSat000 ).
     ...
     SELECT * FROM ZR_RAP_ATRAV_SAT000 INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
